...
class DashboardFrame(ctk.CTkFrame):
    ...
    def setup_summary_frame(self):
        ...
        self.title_label = ctk.CTkLabel(self.summary_frame, text="Monthly Summary",
        ...
        expenses_label = ctk.CTkLabel(expenses_frame, text="Expenses", font=ctk.CTkFont(weight="bold"))
        expenses_label.pack(pady=(5, 0))

        self.expenses_value = ctk.CTkLabel(expenses_frame, text="$0.00", font=ctk.CTkFont(size=24),
                                           text_color="#F44336")
    ...
    def setup_chart_frames(self):
        ...
        bar_title = ctk.CTkLabel(self.bar_frame, text="Income vs. Expenses", font=ctk.CTkFont(size=16, weight="bold"))
